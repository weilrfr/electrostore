...
export const PRODUCTS_DATA: { id: string; data: Omit<Product, 'id' | 'createdAt' | 'updatedAt'> }[] = [
  // ─── СМАРТФОНЫ ─────────────────────────────────────────────────────────────
  {
    ...
    data: {
      ...
      description: 'Флагманский смартфон Apple с титановым корпусом, мощнейшим процессором A17 Pro и передовой системой камер с 5-кратным оптическим зумом.',
  ...
  },
  {
    ...
    data: {
      ...
      category: 'smartphones',
      subcategory: 'xiaomi', // Отнесем к общей ветке или оставим пустым
      price: 380000,
      stock: 20,
      rating: 4.7,
      reviews: 22,
  ...
  },
  {
    ...
    data: {
      ...
      category: 'tvs',
      subcategory: 'oled', // В интерфейсе отнесем к основной премиум категории
      price: 1350000,
  ...
  },
  {
    ...
    data: {
      ...
      category: 'appliances',
      subcategory: 'vacuum', // В интерфейсе отнесем к общей бытовой
      price: 290000,
      stock: 8,
      rating: 4.7,
      reviews: 27,
  ...
  },
  {
    ...
    data: {
      ...
      specifications: {
        ...
        'Особенности': 'Кнопка жестов, боковое колесо прокрутки, тихие клики'
      },
      sku: 'LOGI-MXM3S-GRY',
